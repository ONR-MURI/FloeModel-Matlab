function [ force_1, pcenter, overlap] = floe_interactions_poly(c1, c2)
...
if polyout.NumRegions>0
    ...
    R = regions(polyout2);
    R = R(area(R)>10);
    if ~isempty(area(R));  areaPoly = max(area(R)); else; areaPoly = 0; overlap = 0; end
else
    areaPoly = 0; overlap = 0;
end
