function Floe = floe_interactions_all_doublePeriodicBCs_Heart(Floe, ocean, winds,c2_boundary_poly, dt)
...
for i=1:N  %now the interactions could be calculated in a parfor loop!
    ...
    %no boundaries so commenting this out, unless there are boundaries in
...
%skip the first flow as this is the unmovable Heart!
for i=2:N0
