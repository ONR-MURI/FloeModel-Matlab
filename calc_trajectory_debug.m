function floe=calc_trajectory_debug(dt,ocean,winds,floe,heat_flux,SUBFLOES)
...
if isnan(floe.Xi)||isnan(floe.alpha_i)||isnan(floe.ksi_ice), disp('Ice floe sacked: NaN state vars.'); floe=[];xx = 1;
        xx(1) = [1 2];
else
