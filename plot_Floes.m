function [fig, fig2] =plot_Floes(fig, fig2, Time,Floe,ocean,c2_boundary_poly, im_num, PERIODIC)
...
if (fig==0 || ~isvalid(fig))
    fig=figure('Position',[100 100 1000 1000*ratio],'visible','off');  
...
quiver(ocean.Xo(1:dn:end),ocean.Yo(1:dn:end),ocean.Uocn(1:dn:end,1:dn:end),ocean.Vocn(1:dn:end,1:dn:end),'visible','off');
hold on;
...
if (fig2==0 || ~isvalid(fig2))
    fig2=figure('Position',[100 100 1000 1000*ratio],'visible','off');  
